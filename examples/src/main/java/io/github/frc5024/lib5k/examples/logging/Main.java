 ...
 * to it.
 * 
 * All messages are written to RioLog
 * (https://docs.wpilib.org/en/stable/docs/software/wpilib-overview/viewing-console-output.html)
 * 
 * Any message with the kWarning flag will also be printed directly to
 * DriverStation
 */

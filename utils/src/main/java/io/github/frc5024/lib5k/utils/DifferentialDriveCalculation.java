 ...
 * 
 * NOTE: DifferentialDriveWheelSpeeds is used to express numbers -1 to 1 here. ignore the "meters per second" stuff
 */
public class DifferentialDriveCalculation {
    ...
    public static DifferentialDriveWheelSpeeds normalize(DifferentialDriveWheelSpeeds signal) {
        ...
        if (magnitude > 1.) {
            signal.leftMetersPerSecond /= magnitude;
            signal.rightMetersPerSecond /= magnitude;
        }
